...
create table expand
select distinct RXCUI,RXCUI2,SAB,TTY,REL,RELA,STR from RXNCONSO_curated_rela
where RXCUI2 not in (select distinct RXCUI from RXNCONSO_curated);
...
select distinct RXCUI, RXCUI2, RELA, STR from expand where RELA in ('has_tradename', 'tradename_of')
...
select distinct RXCUI, RXCUI2, RELA, STR from expand where RELA in ('consists_of', 'constitutes')
order by RXCUI,RELA, STR ;
...
select distinct RXCUI, RXCUI2, RELA, STR from expand where RELA in ('isa', 'inverse_isa')
order by RXCUI,RELA, STR ;
...
select distinct RXCUI, RXCUI2, RELA, STR from expand where RELA in (
...
select distinct RXCUI,RXCUI2, RELA, STR from expand where RELA in ('form_of', 'has_form')
order by RXCUI,RELA, STR ;
